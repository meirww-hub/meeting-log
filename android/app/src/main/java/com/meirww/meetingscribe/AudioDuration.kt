 ...
 *
 * הסף נבדק בשתי דרכים שמזינות את העיבוד - ייבוא שיחה מ-cally
 * ([CallImportWorker]) ושיתוף קובץ מבחוץ ([ShareReceiveActivity]) - ותמיד על
 * ההקלטה בשלמותה, לא על קובץ בודד. הקלטת פגישה דרך כפתור ההקלטה באפליקציה
 * ([RecordingRecovery]) לא בודקת מול הסף הזה בכוונה: המשתמש הפעיל את
 * ההקלטה בעצמו, ולכן היא מעובדת תמיד, לא משנה כמה זמן הייתה.
 */
